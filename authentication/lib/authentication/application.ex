defmodule Authentication.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(AuthenticationWeb.Endpoint, []),
      # Start your own worker by calling: Authentication.Worker.start_link(arg1, arg2, arg3)
      # worker(Authentication.Worker, [arg1, arg2, arg3]),
    ]
